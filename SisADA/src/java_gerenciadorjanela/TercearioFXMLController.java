 ...
 */
public class TercearioFXMLController extends InterfaceUsuario{

    private Avaliacao avaliacao;
    public static int indice;
    
    
    public TercearioFXMLController(Avaliacao a, int indice) {
        super("TercearioFXML.fxml","Informar nota");
        avaliacao = a; 
        this.indice = indice;
    }
